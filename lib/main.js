...
T.loadResources = function() {
    ...
    var resources = ['tank_yellow.png', 'tank_green.png', 'tank_blue.png', 'tank_red.png',
        'brick.png', 'cement.png', 'explosion.png'];
...
T.explodeTank = function(playerId) {
    ...
    T.ctx.drawImage(T.textures['explosion'], x, y, T.tankSize[0], T.tankSize[1]);
...
T.renderPlayer = function(data) {
    ...
    var ctx = T.ctx;
    var position = playerInfo.position = data.position;
    ctx.save();
