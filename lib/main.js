...
T.playSound = function(sound) {
    ...
    if ($audio[0].canPlayType('application/ogg;')) {
...
T.renderEntity = function(data, isBullet) {
    ...
    /*if (isBullet) {
        console.log('BULLET', position[0], position[1]);
    }*/
...
T.renderAnimations = function(animations) {
    ...
    for (var i = 0; i < animations.length; i++) {
        ...
        case 'explosion':
            var result = T.renderExplosion(animation);
            if (!result) {
...
T.renderExplosion = function(animation) {
    ...
    console.log('RENDER EXPLOSTION', step);
